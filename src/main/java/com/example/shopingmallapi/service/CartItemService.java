...
import com.example.shopingmallapi.domain.CartItem;
import com.example.shopingmallapi.dto.AddCartItemDto;
import com.example.shopingmallapi.repository.CartItemRepository;
...
public class CartItemService {
    ...
    public boolean isCartItemExist(Long memberId, Long cartId, Long productId) {
        return cartItemRepository.existsByCart_memberIdAndCart_idAndProductId(memberId, cartId, productId);
    }
